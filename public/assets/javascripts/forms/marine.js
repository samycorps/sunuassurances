var Marine = function() {
    return {
        ...
        loadDropdownLists: () => {
            Promise.all([_this.getCoverTypeList(), Utility.getCitiesList(), Utility.getLocationsList()]).then(values => {
                console.log(values);
        ...
        wizardStepThree: () => {
            ...
            const mobileNumber = _this.fields.agentProfile.gsm_number !== '' ? _this.fields.agentProfile.gsm_number : _this.fields.agentProfile.office_number;
            ...
            const handler = PaystackPop.setup({
                ...
                callback: function(response){
                    ...
                    if (_this.fields.transactionDetails !== undefined && !(_.isEmpty(_this.fields.transactionDetails)) && _this.fields.transactionDetails.responseReference !== '') {
                        const vehicleTransactionPayment = {..._this.fields.transactionDetails, vehicleTransactionDetailsId: _this.fields.savedEntry.id};
                        Utility.saveVehiclePaymentDetails(vehicleTransactionPayment).then(result => {
                            console.log(result);
                        })
                        .catch( err => {
                            console.log(err);
        ...
        wizardStepFour: () => {
            ...
            _this.getPolicy(_this.fields.legendData)
        ...
        setLegendData: () => {
            const name = _.isEmpty(_this.fields.selectedProfile.lastname) ? _this.fields.selectedProfile.company_name : _this.fields.selectedProfile.lastname;
            ...
            const data = {
                ...
                gsm_number: _this.fields.agentProfile.gsm_number !== '' ? _this.fields.agentProfile.gsm_number : _this.fields.agentProfile.office_number,
                office_number: _this.fields.agentProfile.gsm_number !== '' ? _this.fields.agentProfile.gsm_number : _this.fields.agentProfile.office_number,
                ...
                bvn: _this.fields.selectedProfile.bank_account_number === '' ? 'N/A' : _this.fields.selectedProfile.bank_account_number,
                bank_id: _this.fields.selectedProfile.customer_bank === '' ? 'N/A' : _this.fields.selectedProfile.customer_bank,
                account_number: _this.fields.selectedProfile.bank_account_number === '' ? 'N/A' : _this.fields.selectedProfile.bank_account_number,
        ...
        populateRatesList: () => {
            ...
            const rateRange = _.map(_.range(1, 51), function(i) { return i / 10; });
            rateRange.map(r => {
        ...
        populateCurrencies: () => {
            ...
            const currencies = ['NGN', 'USD','GBP','SWIS FRANC','YEN','CFA','WAUA','YUAN/RENMINBI','RIYAL','DANISH KRONA','SDR','ZAR','EURO'];
            currencies.map(c => {
        ...
        setPolicyDetails: () => {
            const policyDetails = {
                    ...
                    coverOption: '',
                    coverAddOns: '', 
                    vehicleTransactionDetailsId: _this.fields.savedEntry.id, ..._this.fields.legendResponse};
